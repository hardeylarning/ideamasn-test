...
void main () async{
  ...
  Map _score ;
  var _game ;
  if(year.text.toString() != null && year.text.length ==4){
  ...
  runApp(MaterialApp(
    ...
    home: ScreenRepair(models: dateModel, game: _game,),
  ));
}
//
class ScreenRepair extends StatelessWidget {
  DateModel models;
  var game;
  ScreenRepair({Key key, @required this.models, this.game}) : super(key:key); //  = _score['data']['games']['game'];
  @override
                    ...
                    onPressed: () {
                      ...
                      if((year.text == null && year.text.length != 4) ||
                        ...
                        Navigator.of(context).pushReplacement(MaterialPageRoute(
                            builder: (context) => ScreenRepair(game: game, models: new DateModel(year1, month1, day1),),
